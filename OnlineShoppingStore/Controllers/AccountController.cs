    ...
    public class AccountController : Controller
    {
            ...
            try
            {
                using (var Context = new dbMyOnlineShoppingEntities())
                {
                    ...
                    if (UserReg != null)
                    {
                        ...
                        dbreg.Password = UserReg.ConfirmPassword;
                        dbreg.ConfirmPassowrd = UserReg.ConfirmPassword;
                        ...
                        dbreg.OTP = GeneratePassword();
                        Context.Tbl_Registration.Add(dbreg);
                        Context.SaveChanges();

                        SendEmailToUser(UserReg.Email, UserReg.ActivetionCode.ToString());
                        SendOTPToUser();
                        result = true;
                    }
        ...
        public void SendOTPToUser()
        {
            ...
            try
            {
                ...
                string message = "Your OTP Number is " + otpValue + " ( Sent By : hari )";
                String encodedMessage = HttpUtility.UrlEncode(message);

                using (var webClient = new WebClient())
                {
                    byte[] response = webClient.UploadValues("http://pay4sms.in/sendsms/?token=", new NameValueCollection(){
        ...
        public ActionResult UserVerification(string id)
        {
            ...
            using (var Context = new dbMyOnlineShoppingEntities())
            {
                ...
                var IsVerify = Context.Tbl_Registration.Where(u => u.ActivetionCode == new Guid(id)).FirstOrDefault();
        ...
        [AllowAnonymous]
        public ActionResult UserLogin(UserloingModel UserLogin)
        {
            var result = false;
            try
            {
                ...
                using (var Context = new dbMyOnlineShoppingEntities())
                {
                    ...
                    {
                        if (item.EmailId == UserLogin.UserName && item.Password == UserLogin.Password)
                        {
                            result = true;
                            break;
                        }
